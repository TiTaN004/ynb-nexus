      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Ready to Amplify Your Social Presence?</h2>
            <p className="text-xl text-gray-600 mb-10">
              Let's create a social media strategy that builds communities and drives business growth.
            </p>
