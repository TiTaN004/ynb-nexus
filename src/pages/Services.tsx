  ...
  return (
    <div className="">
      ...
      <Hero
        img={service}
        title="Our Services"
        description="From SEO to billboards – we cover it all with comprehensive marketing solutions."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We provide comprehensive marketing services that help businesses
              attract, engage, and convert their ideal customers across all
              channels.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Discovery",
                description:
                  "We analyze your business, goals, and target audience",
              },
              {
                step: "02",
                title: "Strategy",
                description:
                  "We develop a customized marketing strategy for your needs",
              },
              {
                step: "03",
                title: "Execute",
                description: "We implement campaigns across chosen channels",
              },
              {
                step: "04",
                title: "Optimize",
