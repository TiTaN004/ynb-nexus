...
const Testimonials = () => {
  const testimonials = [
    // --- Creative ---
    {
      ...
      content:
        "The branding and logo design gave our startup a professional identity. Customers now instantly recognize us — a complete game changer!",
      rating: 5,
    },
    {
      name: "Sophia Patel",
      ...
      content:
        "Their packaging design was both stylish and functional. Sales increased noticeably after the launch of our new line.",
      rating: 5,
    },
    {
      name: "Kabir Desai",
      ...
      content:
        "The brochure design captured our services perfectly. Clients were impressed with how clear and attractive our presentation looked.",
      rating: 5,
    },
    ...
    // --- Traditional ---
    {
      ...
      image:
        "https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=687&q=80",
      content:
        "From corporate designing to high-quality printing, the team handled everything seamlessly. Truly professional service.",
      rating: 5,
    },
    {
      name: "Emily Carter",
      ...
      content:
        "Their outdoor publicity and advertising campaigns helped us capture huge attention across the city. Incredible reach!",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="">
      ...
      <Hero
        ...
        img={bgTestimonials}
        description="Hear what our clients have to say about working with YNB Nexus."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our commitment to excellence is reflected in our client
              satisfaction scores.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real feedback from real clients who've experienced the YNB Nexus
              difference.
            </p>
          </motion.div>
