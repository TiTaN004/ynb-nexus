...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(`${API_ENDPOINT}/response/`, formData);
  ...
  return (
    <div className="">
      ...
      <Hero
        title="Contact Us"
        img={contact}
        description="Let's bring your vision to life. Contact us today."
      />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border text-gray-700 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border text-gray-700 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 resize-none"
            ...
            <div className="flex items-start">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-600 break-words truncate sm:whitespace-normal">
                  <a href="mailto:ynbnexus@gmail.com" className="text-gray-600">
                    ynbnexus@gmail.com
                  </a>
                </p>
              </div>
            ...
            <div className="flex items-start">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-600 break-words">
                  202 - Radium Square, Bhakti Nagar Station Plot,
                  <br />
