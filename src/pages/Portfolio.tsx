  ...
  const caseStudies = [
    {
      ...
      challenge:
        "Build a strong digital presence to attract enterprise clients",
      strategy:
    ...
    },
    {
      ...
      results: [
        ...
        {
          metric: "500+",
          description: "Leads generated from digital campaigns",
        },
        { metric: "40%", description: "Increase in brand search volume" },
      ],
      timeline: "6 months",
      image:
        "https://images.pexels.com/photos/236089/pexels-photo-236089.jpeg?auto=compress&cs=tinysrgb&w=800",
    ...
    },
    {
      ...
      strategy:
        "Corporate website redesign + SEO optimization + LinkedIn outreach",
      results: [
        ...
        {
          metric: "150+",
          description: "New dealer and distributor connections",
        },
      ],
      timeline: "5 months",
      image: steel,
  ...
  return (
    <div className="">
      ...
      <Hero
        title="Our Portfolio"
        img={portfolio}
        description="Real strategies. Real results. Explore success stories from our satisfied clients."
      />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dive deep into how we've helped businesses transform their
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-between">
                      ...
                      <div className="mb-6 flex justify-evenly items-center flex-col md:flex-row">
                        <img
                          src={study.logo}
                          alt="logo"
                          className="w-[15%] min-w-[30%] md:min-w-[15%]"
                        />
                        <div>
