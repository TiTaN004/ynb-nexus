  ...
  return (
    <div className="">
      ...
      <Hero
        ...
        description="Your trust and privacy matter. Learn how we protect and use your information."
      />
          ...
          >
            <div className="bg-blue-50 border-l-4 border-blue-900 p-6 rounded-r-lg mb-12">
              <p className="text-lg text-gray-800 mb-0">
                At YNB Nexus, we are committed to protecting your privacy and
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  provide to us when you interact with our website. This may
                  include your name, email address, phone number, and any other
                  information you provide when filling out forms on our site.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  The personal information we collect may be used to respond to
                  your inquiries, provide you with requested services, process
                  transactions, and improve our website's user experience. We
                  may also use your information to send you promotional emails
                  about our services or updates about our company, but you will
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  website or conducting our business, as long as they agree to
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  experience. Cookies are small files stored on your computer's
                  hard drive that help us analyze web traffic or recognize you
                  when you visit our site. You can choose to accept or decline
                  cookies through your browser settings, but this may limit some
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  not operated by us. We have no control over the content,
                  privacy policies, or practices of these websites and encourage
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  contact us, and we will promptly delete such information from
                  our records.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  effective immediately upon posting on this page, and your
                  continued use of our website after such modifications will
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  This Privacy Policy and any disputes arising out of your use
                  of our website shall be governed by the laws of Rajkot,
                  Gujarat, India.
                </p>
                <p className="text-gray-700 mb-4">
                  If you have any questions or concerns about our Privacy
                  Policy, please contact us at hello@ynbnexus.in.
                </p>
