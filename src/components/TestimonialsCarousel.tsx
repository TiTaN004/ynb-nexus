...
const testimonials = [
  {
    ...
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b5c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&h=687&q=80",
          ...
          <div className="flex animate-slide-left">
            {duplicatedTestimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex-shrink-0 w-80 mx-4 text-center group"
              >
