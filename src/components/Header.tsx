                              ...
                              <div className="grid grid-cols-1 gap-1 px-3">
                                {item.submenu.map((subItem, index) => (
                                  ...
                                  >
                                    <Link
                                      to={subItem.path}
                                      className=" block px-4 py-3 text-sm rounded-xl transition-all duration-200 group font-medium"
                                    >
                                      <span className="group-hover:translate-x-1 transition-transform duration-200 inline-block text-gray-900">
                                        {subItem.title}
                                      </span>
                                    </Link>
                                  </motion.div>
